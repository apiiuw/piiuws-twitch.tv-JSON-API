$(function () {
  ...
  function displayUsers(data, status) {
    ...
    if (!displayName) {
      displayName = data.message.userStatus = data.message.split(" ").slice(1).join(" ");
    }
    ...
    html =
      ...
      '"><img src="' +
      logo +
      '" + "height="35" width="35" class="logo""><a href="' +
      url +
      '" target="_blank"><span class="displayName">' +
      displayName +
      '</span></a><div class="status">' +
      userStatus +
      "</div></div></div>";
